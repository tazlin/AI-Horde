...
arg_parser.add_argument('-i', '--insecure', action="store_true", default=True, help="If set, will use http instead of https (useful for testing)")
...
arg_parser.add_argument('--horde', action='store', default='stable', required=False, type=str, help="Which Horde to Start. This customizes endpoints and methods")
